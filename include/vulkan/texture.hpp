...
public:
  ...
  virtual void setCurrentDeviceAndPhysic(
      VkDevice device, VkPhysicalDevice physicalDevice, VkQueue graphicsQueue,
      VkCommandPool commandPool,
      VkPhysicalDeviceMemoryProperties memoryProperties,
      VkRenderPass renderPass, VkPhysicalDeviceProperties deviceProps,
      VkPhysicalDeviceFeatures deviceFeatures, VkDescriptorPool descriptorPool,
    ...
    try {
      ...
      DEBUG_LOG("Size current framebuffers: %i",
                static_cast<int>(currentFrameBuffers.size()));
  ...
  bool isTextureLoaded() const {
    return texture.view != VK_NULL_HANDLE && texture.sampler != VK_NULL_HANDLE;
  }
  void prepareFrame();
