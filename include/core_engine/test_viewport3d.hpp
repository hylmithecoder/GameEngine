...
class Viewport3D {
    public:
        ...
        void helperInitImage(){
            ...
            textureHandler.setCurrentDeviceAndPhysic(g_Device, g_PhysicalDevice, g_Queue, offscreenCommandPool, memoryProperties, renderPass, deviceProps, deviceFeatures, g_DescriptorPool, framebuffers);
        }
