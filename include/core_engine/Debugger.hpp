...
static void ShowBox(GtkWindow *parent, const char *message,
...
static void ShowBox(GtkWindow *parent, const string &message,
                    GtkMessageType type = GTK_MESSAGE_INFO) {
...
#define NOTIF_LOG_WITH_LOCATIONF_WITH_ARGS_WITH_LOCATION(title, format, level, \
                                                         file, line, ...)      \
  do {                                                                         \
    if (!notify_init("Ilmeee Engine"))                                         \
      break;                                                                   \
