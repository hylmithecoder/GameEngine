...
#endif
#include "../../include/vulkan/VkDevice.hpp"
...
{	
	...
	*/
	VkResult VulkanDevice::createBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, VkDeviceSize size, VkBuffer *buffer, VkDeviceMemory *memory, void *data)
	{
		...
		VkBufferCreateInfo bufferCreateInfo = vkhandler::initializers::bufferCreateInfo(usageFlags, size);
		bufferCreateInfo.sharingMode = VK_SHARING_MODE_EXCLUSIVE;
		VK_CHECK_RESULT(vkCreateBuffer(logicalDevice, &bufferCreateInfo, nullptr, buffer));

		// Create the memory backing up the buffer handle
		VkMemoryRequirements memReqs;
		VkMemoryAllocateInfo memAlloc = vkhandler::initializers::memoryAllocateInfo();
	...
	* @return VK_SUCCESS if buffer handle and memory have been created and (optionally passed) data has been copied
	*/
	VkResult VulkanDevice::createBuffer(VkBufferUsageFlags usageFlags, VkMemoryPropertyFlags memoryPropertyFlags, vkhandler::Buffer *buffer, VkDeviceSize size, void *data)
	{
	...
	*/
	void VulkanDevice::copyBuffer(vkhandler::Buffer *src, vkhandler::Buffer *dst, VkQueue queue, VkBufferCopy *copyRegion)
	{
	...
	*/
	...
	{
		VkCommandBufferAllocateInfo cmdBufAllocateInfo = vkhandler::initializers::commandBufferAllocateInfo(pool, level, 1);
	...
	*/
	void VulkanDevice::flushCommandBuffer(VkCommandBuffer commandBuffer, VkQueue queue, VkCommandPool pool, bool free)
	{
		...
		VkFenceCreateInfo fenceInfo = vkhandler::initializers::fenceCreateInfo(VK_FLAGS_NONE);
		VkFence fence;
