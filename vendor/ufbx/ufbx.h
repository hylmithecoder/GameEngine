...
typedef struct ufbx_scene_settings {
  ...
  // NOTE: This may be `UFBX_COORDINATE_AXIS_UNKNOWN` if not specified in the
  // file.
...
typedef void ufbx_thread_pool_wait_fn(void *user, ufbx_thread_pool_context ctx,
...
ufbx_abi ufbx_element *ufbx_find_prop_element_len(const ufbx_element *element,
                                                  ...
                                                  size_t name_len,
                                                  ufbx_element_type type);
ufbx_abi ufbx_element *ufbx_find_prop_element(const ufbx_element *element,
                                              const char *name,
                                              ufbx_element_type type);
...
ufbx_abi ufbx_element *ufbx_find_element_len(const ufbx_scene *scene,
                                             ufbx_element_type type,
                                             const char *name, size_t name_len);
ufbx_abi ufbx_element *ufbx_find_element(const ufbx_scene *scene,
                                         ufbx_element_type type,
                                         const char *name);
...
ufbx_abi ufbx_anim_stack *ufbx_find_anim_stack_len(const ufbx_scene *scene,
                                                   const char *name,
                                                   size_t name_len);
ufbx_abi ufbx_anim_stack *ufbx_find_anim_stack(const ufbx_scene *scene,
                                               const char *name);
...
ufbx_abi ufbx_material *ufbx_find_material_len(const ufbx_scene *scene,
                                               const char *name,
                                               size_t name_len);
ufbx_abi ufbx_material *ufbx_find_material(const ufbx_scene *scene,
                                           const char *name);
...
ufbx_abi ufbx_anim_prop *ufbx_find_anim_prop_len(const ufbx_anim_layer *layer,
                                                 ...
                                                 const char *prop,
                                                 size_t prop_len);
ufbx_abi ufbx_anim_prop *ufbx_find_anim_prop(const ufbx_anim_layer *layer,
                                             const ufbx_element *element,
                                             const char *prop);
...
ufbx_abi bool ufbx_open_file(ufbx_stream *stream, const char *path,
                             size_t path_len, const ufbx_open_file_opts *opts,
                             ufbx_error *error);
ufbx_unsafe ufbx_abi bool ufbx_open_file_ctx(ufbx_stream *stream,
                                             ufbx_open_file_context ctx,
                                             const char *path, size_t path_len,
                                             const ufbx_open_file_opts *opts,
                                             ufbx_error *error);
...
ufbx_abi bool ufbx_open_memory(ufbx_stream *stream, const void *data,
                               ...
                               ufbx_error *error);
ufbx_unsafe ufbx_abi bool
ufbx_open_memory_ctx(ufbx_stream *stream, ufbx_open_file_context ctx,
...
ufbx_abi ufbx_real ufbx_evaluate_blend_weight(const ufbx_anim *anim,
                                              ...
                                              double time);
ufbx_abi ufbx_real ufbx_evaluate_blend_weight_flags(
...
ufbx_abi ufbx_baked_node *
ufbx_find_baked_node_by_typed_id(ufbx_baked_anim *bake, uint32_t typed_id);
ufbx_abi ufbx_baked_node *ufbx_find_baked_node(ufbx_baked_anim *bake,
                                               ufbx_node *node);

ufbx_abi ufbx_baked_element *
ufbx_find_baked_element_by_element_id(ufbx_baked_anim *bake,
                                      uint32_t element_id);
ufbx_abi ufbx_baked_element *ufbx_find_baked_element(ufbx_baked_anim *bake,
                                                     ufbx_element *element);
...
ufbx_abi ufbx_texture *ufbx_find_prop_texture_len(const ufbx_material *material,
                                                  const char *name,
                                                  size_t name_len);
ufbx_abi ufbx_texture *ufbx_find_prop_texture(const ufbx_material *material,
                                              const char *name);
...
ufbx_abi ufbx_string ufbx_find_shader_prop_len(const ufbx_shader *shader,
                                               const char *name,
                                               size_t name_len);
ufbx_abi ufbx_string ufbx_find_shader_prop(const ufbx_shader *shader,
                                           const char *name);
...
ufbx_abi uint32_t ufbx_catch_triangulate_face(ufbx_panic *panic,
                                              ...
                                              ufbx_face face);
ufbx_abi uint32_t ufbx_triangulate_face(uint32_t *indices, size_t num_indices,
...
ufbx_abi uint32_t ufbx_catch_topo_next_vertex_edge(ufbx_panic *panic,
                                                   ...
                                                   size_t num_topo,
                                                   uint32_t index);
ufbx_abi uint32_t ufbx_topo_next_vertex_edge(const ufbx_topo_edge *topo,
...
ufbx_abi uint32_t ufbx_catch_topo_prev_vertex_edge(ufbx_panic *panic,
                                                   ...
                                                   size_t num_topo,
                                                   uint32_t index);
ufbx_abi uint32_t ufbx_topo_prev_vertex_edge(const ufbx_topo_edge *topo,
                                             size_t num_topo, uint32_t index);
...
ufbx_abi ufbx_dom_node *ufbx_dom_find_len(const ufbx_dom_node *parent,
                                          const char *name, size_t name_len);
ufbx_abi ufbx_dom_node *ufbx_dom_find(const ufbx_dom_node *parent,
                                      const char *name);
...
ufbx_abi ufbx_real ufbx_catch_get_vertex_w_vec3(ufbx_panic *panic,
                                                const ufbx_vertex_vec3 *v,
                                                size_t index);
ufbx_inline ufbx_real ufbx_get_vertex_w_vec3(const ufbx_vertex_vec3 *v,
                                             size_t index) {
  ufbx_assert(index < v->indices.count);
